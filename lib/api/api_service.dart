...
Future<List<Map<String, dynamic>>> fetchProduk() async {
  final response = await http.get(Uri.parse('https://umkmapi.azurewebsites.net/produk'));
  ...
  if (response.statusCode == 200) {
    ...
    final List<Map<String, dynamic>> listProperties = data.cast<Map<String, dynamic>>();
...
Future<List<Map<String, dynamic>>> fetchMakanan() async {
  final response = await http.get(Uri.parse('https://umkmapi.azurewebsites.net/produk/makanan'));
...
Future<List<Map<String, dynamic>>> fetchMinuman() async {
  final response = await http.get(Uri.parse('https://umkmapi.azurewebsites.net/produk/minuman'));
...
Future<List<Map<String, dynamic>>> fetchMisc() async {
  final response = await http.get(Uri.parse('https://umkmapi.azurewebsites.net/produk/misc'));
